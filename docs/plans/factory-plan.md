...
| 09-22 F5 | **`docs/web.md` に Factory の行が無い**（表もサイズも）。F6 の仕事だが、今の数はある: `factory/pkg/game_bg.wasm` 35,665,656 B、`factory/assets` 11,326 B / 4 ファイル、ガイドのフォント 81,480 B（3 本とも増えた） | `docs/web.md` | 文書 | **F6 で**（計画の F6 の行がそう言っている） |
