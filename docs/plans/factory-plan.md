...
| 09-21 F1 | **窓の走行 3 本と `--shot` は Docker が応えず未確認**（ブラウザの絵で画素を数えて代えた） | worklog F1 §5 | 確認の抜け | Docker が動いているときに F2 の最初で回す |
